...
The model was able to correctly guess 4 of the 5 traffic signs, which gives an accuracy in range 36%-52%. This compares favorably to the accuracy on the test set of ...
